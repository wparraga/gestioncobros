		...
		if (empty($_POST['firstname'])){
            ...
            include ("../../../config/swee.php");
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO users (firstname, lastname, user_name, user_password_hash, user_email, date_added,user_king,user_status)
                            VALUES('".$firstname."','".$lastname."','" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . "','".$date_added."','".$perfil."','".$estado."');";
