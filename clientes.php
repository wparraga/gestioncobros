  ...
  <body>
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<?php
				include("views/modal/clientes/registro_clientes.php");
				include("views/modal/clientes/editar_clientes.php");
			?>
			<form class="form-horizontal" role="form" id="">
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<input type="button" name="boto" onclick='load(1);' style="display: none;">
								<span id="loader"></span>
							</div>
